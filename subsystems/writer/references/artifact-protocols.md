...
创建参考：`references\craft\character-relations.md` (人物关系类型 + 关系图绘制)
...
创建参考：`references\craft\genre-core-mechanics.md` (核心梗解析与运用 + 微创新与差异化设计)
...
创建参考：`outline-methods.md` (大纲三层结构法) + `outline-rhythm.md` (升级感三步设计法) + `references\craft\emotional-arc-design.md` (六种弧线速查) + `references\craft\reversal-toolkit.md` (五种反转类型)
...
创建参考：`references\craft\state-tracking.md` (角色状态快照格式 + 更新规则)
